...
import com.bigo.dialog.PhysiognomyDlg;
...
public class PhysiognomyActv extends Activity {
	...
	private PhysiognomyDlg dialog;
//	private TakePhotoSvc takePhoto;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		dialog = new PhysiognomyDlg(this);
...
/*		Button picBtn = (Button) findViewById(R.id.btnIntend);
		...
		Button picSBtn = (Button) findViewById(R.id.take_photo);
		setBtnListenerOrDisable( 
				picSBtn, 
...
//		takePhoto = new TakePhotoSvc(this);
	}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		mobileContact.onActivityResult(requestCode, resultCode, data);
	}
	...
	private void setBtnListenerOrDisable( 
		...
		if (isIntentAvailable(this, intentName)) {
			...
			btn.setText( 
				getText(R.string.txt_cannot).toString() + " " + btn.getText());
